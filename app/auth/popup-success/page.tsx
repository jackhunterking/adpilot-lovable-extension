...
function PopupSuccessContent() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      // Notify the opener (iframe) that auth succeeded
      if (window.opener && !window.opener.closed) {
        console.log('[POPUP-SUCCESS] Notifying opener window')
        
        // Send message to opener
        window.opener.postMessage(
          { type: 'OAUTH_SUCCESS', next },
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-500 to-cyan-500">
      <div className="text-center text-white p-8 space-y-4">
        ...
        <p className="text-blue-100">Completing sign in...</p>
